    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppColors2.purple.withOpacity(0.2),
            AppColors2.blue.withOpacity(0.1),
          ],
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(
                colors: [AppColors2.purple, AppColors2.blue],
              ),
              boxShadow: [
                BoxShadow(
                  color: AppColors2.purple.withOpacity(0.4),
                  blurRadius: 16,
                ),
              ],
            ),
          ...
          Column(
            children: [
              ...
              Text(
                'voice',
                style: GoogleFonts.dmSans(color: AppColors2.ts, fontSize: 10),
              ),
            ],
          ),
        ],
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppColors2.purple.withOpacity(0.1),
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(
                            color: AppColors2.purple.withOpacity(0.35),
                          ),
                        ),
                        child: Text(
                          'AI Engine v2',
                              ...
                              _prefRow(
                                ...
                                SliderTheme(
                                  data: SliderThemeData(
                                    activeTrackColor: AppColors2.green,
                                    inactiveTrackColor: AppColors2.s2,
                                    thumbColor: AppColors2.green,
                                    overlayColor: AppColors2.green.withOpacity(
                                      0.15,
                                    ),
