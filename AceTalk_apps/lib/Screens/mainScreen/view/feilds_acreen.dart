...
// // lib/features/fields/presentation/pages/fields_screen.dart
...
//     {'label': 'Beginner', 'icon': Icons.spa_rounded,                   'color': AppColors.accentGreen},
//     {'label': 'Easy',     'icon': Icons.eco_rounded,                   'color': Color(0xFF69F0AE)},
//     {'label': 'Medium',   'icon': Icons.bolt_rounded,                  'color': AppColors.accentGold},
//     {'label': 'Hard',     'icon': Icons.local_fire_department_rounded, 'color': AppColors.accentRed},
//   ];
...
//             final isSelected = state.level == lvl['label'];
//             final color = lvl['color'] as Color;
//             return GestureDetector(
//               onTap: () {
//                 HapticFeedback.selectionClick();
//                 context.read<FieldsBloc>().add(
//                     FieldsLevelChanged(lvl['label'] as String));
//               },
...
//                       borderRadius: BorderRadius.circular(10),
//                     ),
//                     child: Icon(lvl['icon'] as IconData,
//                         color: isSelected
//                             ? color
...
//                 HapticFeedback.selectionClick();
//                 context.read<FieldsBloc>().add(
//                     FieldsRoundChanged(round['label'] as String));
//               },
//               child: AnimatedContainer(
//                 duration: const Duration(milliseconds: 250),
//                 curve: Curves.easeOutCubic,
...
//               enabled: state.questionCount > FieldsState.minQuestions,
//               onTap: () {
...
//               enabled: state.questionCount < FieldsState.maxQuestions,
//               onTap: () {
//                 HapticFeedback.lightImpact();
//                 context.read<FieldsBloc>().add(
//                     FieldsQuestionCountChanged(state.questionCount + 1));
